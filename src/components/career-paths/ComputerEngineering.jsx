...
export default function ComputerEngineering({ onBack }) {
    ...
    <div className="skills-container">
      <div className="skills-content">
        ...
        <div className="skills-header">
          <h2 className="skills-title">Computer Engineering Career Path</h2>
          <p className="skills-subtitle">
            Build the future with computer engineering. Select your skills to discover software, hardware, and systems engineering roles.
          </p>
        </div>
        ...
        <div className="skills-card">
          <h3 className="skills-main-title">
            ...
            Your Computer Engineering Skills
          </h3>
        ...
        <div className="interests-card">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-300 mb-3">
              Which computer engineering areas interest you? (Select multiple)
            </label>
        ...
        <div className="submit-section">
          ...
          >
            Analyze My Computer Engineering Career Path ›
          </button>
          <p className="submit-note">
            {selectedSkills.length === 0 
              ? 'Select some skills to analyze career paths' 
              : 'We\'ll match your skills with suitable computer engineering roles'}
          </p>
        </div>
        ...
        {showJobRecommendations && (
          <div className="job-recommendations-card">
            <h3 className="section-title">Recommended Computer Engineering Roles</h3>
